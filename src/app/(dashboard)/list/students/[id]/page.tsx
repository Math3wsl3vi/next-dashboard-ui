    ...
    <div className="flex-1 p-4 flex flex-col gap-4 lg:flex-row">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="bg-lamaSky px-4 py-6 rounded-md flex-1 flex gap-4">
                <div className="w-1/3">
                <Image src="https://images.pexels.com/photos/3807755/pexels-photo-3807755.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" width={144} height={144} className="w-36 h-36 rounded-full object-cover" />
                </div>
                <div className="w-2/3 flex flex-col justify-end gap-4">
                <h1 className="text-lg font-semibold">Anaerobic Respiration</h1>
        ...
        <div className="bg-white p-4 rounded-md">
            ...
            <Link href="/" className="p-3 rounded-md bg-lamaSkyLight">Students&apos;s Teachers</Link>
            <Link href="/" className="p-3 rounded-md bg-lamaPurpleLight">Students&apos;s Students</Link>
            <Link href="/" className="p-3 rounded-md bg-lamaYellowLight">Students&apos;s Results</Link>
